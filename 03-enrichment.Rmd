...
- Download the result and open in Excel
- Create a new file with Gene Symbol in the first column and log fold-change in the second column.
- Save as a new file and name it `gsea_input.rnk`.
- Go to and download the website http://ge-lab.org/gskb/ and download the file [http://ge-lab.org/gskb/2-MousePath/MousePath_Pathway_gmt.gmt](MousePath_Pathway_gmt.gmt)
...
- Select the *GSEAPreranked* option from tools. You will need to choose what set of genes to use in the analysis. There are many curated *Human* gene sets available through msigDB. However, from http://ge-lab.org/gskb/ we can download gene sets for other organisms.
