...
- If you have problems creating the annotation files, you can download them

- [B.preg_vs_lactation_annotated.tsv.tabular](B.preg_vs_lactation_annotated.tsv.tabular)
- [background_annotated.tsv.tabular](background_annotated.tsv.tabular)
...
- Go to and download the website http://baderlab.org/GeneSets and download the file [Mouse_Human_MSigdb_May_01_2020_Entrezgene.gmt](http://download.baderlab.org/EM_Genesets/current_release/Mouse/Entrezgene/Pathways/Mouse_Human_MSigdb_May_01_2020_Entrezgene.gmt)
